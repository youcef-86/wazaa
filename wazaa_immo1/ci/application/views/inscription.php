...
<html lang="fr">
    ...
    <body class="mx-5">
        ...
        <div id="bloc">
            ...
            <hr><br>
            <h2 class="text-center">Créer un compte</h2><br>
            ...
            <form id="inscription">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="prénom" id="prénom" placeholder="Prénom" required>
                </div>
                           <!-- login -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="confirmationpassword" id="confirmationpassword" placeholder="Confirmation du Mot de passe" required>
                </div>
             
                       <!-- bouton d'inscription -->
                <div>
                    <center><button type="submit" class="btn btn-success" value="inscription">inscription</button></center> 
                </div><br>
            </form>
        </div> <br>  
